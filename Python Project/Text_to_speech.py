...
var = IntVar()
r1 = Radiobutton(root, text="Type Text", variable=var, value=0, command=type_text).place(x=590, y=160)
r2 = Radiobutton(root, text="Input File", variable=var, value=1, command=input_file).place(x=760, y=160)

# Creating Labels
Label(root, text="VOICE", font = "20", bg=bk, fg=w).place(x=595, y = 230)
Label(root, text="SPEED", font = "20", bg=bk, fg=w).place(x=760, y = 230)
Label(top_frame, text="TEXT TO SPEECH", font="arial 20 bold", bg=w, fg=bk).place(x=100, y=30)
